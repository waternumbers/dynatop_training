...
- basic simulation changing showing process
- change parameters for some or all of the HRUs
- introduce 
  - setting the maps (possibly do in visualisation??)
  - saving states 
  - difference between running just hillslope or hillslope and channel
