...
Pandoc provides [installation instructions](https://pandoc.org/installing.html).
In both cases it is presumed that the installed packages are available from the command line.
...
- Linux: ensure that gcc and gcc-c++ compilers are installed along with the
  boost libraries and their development headers
