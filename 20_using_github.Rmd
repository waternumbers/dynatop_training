...
repository.
   ...
   ```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Github repository of waternumbers"}
...
3. To edit the code you will need a copy on your local machine. To do this you
   ...
   ```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Example of the output of a git clone command"}
...
4. When working on code changes you normally want to the leave the
   ...
   **branch** which can be used as outlined in the figure below.
   ...
   ```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Splitting and merging a branch as part of a workflow"}
   ...
   ```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Adding a new branch"}
...
4. Next we will make a simple change to one of the files. Enter the dynatop
   ...
   ```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Edited DESCRIPTION file. Highlighted area shows the changes"}
...
7. Finally to merge the change back into the master branch you would open a
   ...
   ```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Opening a pull request"}
