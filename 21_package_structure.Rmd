...
```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Contents of the dynatop directory"}
...
```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Partial contents of xts_utilities.R"}
